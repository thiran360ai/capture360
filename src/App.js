...
const App = () => {
  ...
  useEffect(() => {
    const fetchProjectData = async () => {
      try {
        const response = await fetch(
          "https://5c85-103-175-108-209.ngrok-free.app/building/projectlist/",
          {
            headers: {
    ...
    const fetchEmployeeData = async () => {
      try {
        const response = await fetch(
          "https://5c85-103-175-108-209.ngrok-free.app/building/create_user/",
          {
            headers: {
              Accept: "application/json",
              "ngrok-skip-browser-warning": "98547",
                ...
                <Route path="/" element={
                  <>
                    <div className="card-container">
                      ...
                      <div className="card">
                        <CustomCard title="Total Employee" count={totalEmployees} />
                      </div>
                      <div className="card">
                        <CustomCard title="Live Employee" count={liveEmployees} />
                      </div>
                    </div>
                    <ProjectTable />
                  </>
